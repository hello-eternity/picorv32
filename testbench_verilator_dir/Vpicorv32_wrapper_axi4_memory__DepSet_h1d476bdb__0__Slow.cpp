...
VL_ATTR_COLD void Vpicorv32_wrapper_axi4_memory___eval_static__TOP__picorv32_wrapper__mem(Vpicorv32_wrapper_axi4_memory* vlSelf) {
    ...
    // Body
    vlSelf->__PVT__xorshift64_state = 0x139408dcbbf7a44ULL;
    vlSelf->__PVT__fast_axi_transaction = 7U;
    vlSelf->__PVT__async_axi_transaction = 0x1fU;
    vlSelf->__PVT__delay_axi_transaction = 0U;
    vlSelf->__PVT__latched_raddr_en = 0U;
    vlSelf->__PVT__latched_waddr_en = 0U;
    vlSelf->__PVT__latched_wdata_en = 0U;
    vlSelf->__PVT__fast_raddr = 0U;
    vlSelf->__PVT__fast_waddr = 0U;
    vlSelf->__PVT__fast_wdata = 0U;
}
...
VL_ATTR_COLD void Vpicorv32_wrapper_axi4_memory___eval_initial__TOP__picorv32_wrapper__mem(Vpicorv32_wrapper_axi4_memory* vlSelf) {
    ...
    // Body
    vlSelf->__PVT__verbose = (0U != VL_TESTPLUSARGS_I(
                                                      std::string{"verbose"}));
    vlSelf->__PVT__axi_test = (0U != VL_TESTPLUSARGS_I(
                                                       std::string{"axi_test"}));
    vlSelf->__PVT__mem_axi_awready = 0U;
    vlSelf->__PVT__mem_axi_wready = 0U;
    vlSelf->__PVT__mem_axi_bvalid = 0U;
    vlSelf->__PVT__mem_axi_arready = 0U;
    vlSelf->__PVT__mem_axi_rvalid = 0U;
    vlSelf->__PVT__tests_passed = 0U;
}
...
VL_ATTR_COLD void Vpicorv32_wrapper_axi4_memory___ctor_var_reset(Vpicorv32_wrapper_axi4_memory* vlSelf) {
    ...
    vlSelf->__Vdlyvdim0__memory__v0 = 0;
    vlSelf->__Vdlyvlsb__memory__v0 = 0;
    vlSelf->__Vdlyvval__memory__v0 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v0 = 0;
    vlSelf->__Vdlyvdim0__memory__v1 = 0;
    vlSelf->__Vdlyvlsb__memory__v1 = 0;
    vlSelf->__Vdlyvval__memory__v1 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v1 = 0;
    vlSelf->__Vdlyvdim0__memory__v2 = 0;
    vlSelf->__Vdlyvlsb__memory__v2 = 0;
    vlSelf->__Vdlyvval__memory__v2 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v2 = 0;
    vlSelf->__Vdlyvdim0__memory__v3 = 0;
    vlSelf->__Vdlyvlsb__memory__v3 = 0;
    vlSelf->__Vdlyvval__memory__v3 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v3 = 0;
    vlSelf->__Vdlyvdim0__memory__v4 = 0;
    vlSelf->__Vdlyvlsb__memory__v4 = 0;
    vlSelf->__Vdlyvval__memory__v4 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v4 = 0;
    vlSelf->__Vdlyvdim0__memory__v5 = 0;
    vlSelf->__Vdlyvlsb__memory__v5 = 0;
    vlSelf->__Vdlyvval__memory__v5 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v5 = 0;
    vlSelf->__Vdlyvdim0__memory__v6 = 0;
    vlSelf->__Vdlyvlsb__memory__v6 = 0;
    vlSelf->__Vdlyvval__memory__v6 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v6 = 0;
    vlSelf->__Vdlyvdim0__memory__v7 = 0;
    vlSelf->__Vdlyvlsb__memory__v7 = 0;
    vlSelf->__Vdlyvval__memory__v7 = VL_RAND_RESET_I(8);
    vlSelf->__Vdlyvset__memory__v7 = 0;
}
