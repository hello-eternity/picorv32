    ...
    , TOP__picorv32_wrapper__mem{this, Verilated::catName(namep, "picorv32_wrapper.mem")}
{
    ...
    // Setup scopes
    __Vscope_picorv32_wrapper__mem.configure(this, name(), "picorv32_wrapper.mem", "mem", 0, VerilatedScope::SCOPE_OTHER);
    // Setup export functions
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_picorv32_wrapper__mem.varInsert(__Vfinal,"memory", &(TOP__picorv32_wrapper__mem.memory), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,2 ,31,0 ,0,32767);
    }
}
